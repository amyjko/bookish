...
function Text(props) {
    ...
    if(context && context.app.getHighlightedWord()) {
        const app = context.app
        let query = app.getHighlightedWord();
        let text = node.text;
    ...
    else return <span key={key} className="text" data-position={node.position}>{node.text}</span>;

...
function insertTableRowColumn(
    ...
    return rootWithNode(
        ...
        table,
        row
            ? table.withNewRow(location.row + (before ? 0 : 1))
            : table.withNewColumn(location.column + (before ? 0 : 1)),
        (t) =>
            (
...
function deleteTableRowColumn(
    ...
    return rootWithNode(
        ...
        table,
        row
            ? table.withoutRow(location.row)
            : table.withoutColumn(location.column),
        (t) => {
            return (
                row
                    ? (t as TableNode).getCell(
...
const commands: Command[] = [
            ...
            if (
                ...
                return {
                    ...
                    range:
                        nextCaret === undefined
                            ? {
                                  start: sortedRange.start,
                                  end: sortedRange.start,
                              }
    ...
    },
    {
        ...
        handler: (context) => {
            if (
                ...
                return {
                    root: context.root,
                    range: { start: previous, end: previous },
                };
            }
        },
    },
    ...
    },
    {
        ...
        handler: (context) => {
            if (
                ...
                return {
                    root: context.root,
                    range: { start: context.start, end: previous },
                };
            }
        },
    },
        ...
        handler: (context) => {
            if (
                ...
                return {
                    ...
                    range:
                        nextCaret === undefined
                            ? { start: sortedRange.end, end: sortedRange.end }
                            : { start: nextCaret, end: nextCaret },
                };
            }
        },
    ...
    },
    {
        ...
        handler: (context) => {
            if (
                ...
                return {
                    root: context.root,
                    range: { start: context.start, end: next },
                };
            }
        },
    },
        ...
        handler: (context) => {
            ...
            if (context.atom) {
                ...
                return {
                    root: context.root,
                    range: {
                        start: format.getFirstCaret(),
                        end: format.getLastCaret(),
                    },
                };
            }
            // If in a code node, expand to the code.
            else if (
                context.block instanceof CodeNode &&
                context.range.start.node === context.block.getCodeNode()
            ) {
                const code = context.block.getCodeNode();
                return {
                    root: context.root,
                    range: {
                        start: { node: code, index: 0 },
                        end: { node: code, index: code.getLength() },
                    },
                };
            }
    ...
    },
    {
        ...
        handler: (context, utilities) => {
            ...
            return {
                root: context.root,
                range: { start: context.start, end: above },
            };
        },
    },
    {
    ...
    },
    {
        ...
        handler: (context, utilities) => {
            ...
            return {
                root: context.root,
                range: { start: context.start, end: below },
            };
        },
    },
    {
    ...
    },
    {
        ...
        handler: (context) => {
            ...
            if (
                lastItem !== undefined &&
                lastCaret !== undefined &&
                lastCaret.node instanceof TextNode &&
                lastCaret.node.getLength() === 0 &&
                lastCaret.node === context.end.node &&
                lastCaret.index === context.end.index
            ) {
                ...
                if (listParent instanceof ListNode) {
                    ...
                    const newListWithoutSublistItem =
                        listParent.withChildReplaced(context.list, newSublist);
    ...
    },
    {
        ...
        visible: false,
        active: (context) =>
            context.atom === undefined && context.blocks !== undefined,
        handler: (context) => {
    ...
    },
    {
        ...
        active: (context) =>
            ...
            context.list.isInside(context.root, ListNode),
        handler: (context) =>
            rootWithNode(
                context,
                context.blocks,
    ...
    },
    {
        ...
        handler: (context) =>
            context.root.withRangeFormatted(context.range, ''),
    },
    {
        icon: BoldIcon,
        description: 'bold',
    ...
    },
    {
        ...
        active: (context) => context.startIsText || context.endIsText,
        handler: (context) =>
            context.root.withRangeFormatted(context.range, '_'),
    },
    {
        icon: SubscriptIcon,
        ...
        active: (context) => context.startIsText || context.endIsText,
        handler: (context) =>
            context.root.withRangeFormatted(context.range, 'v'),
    },
    {
    ...
    },
    {
        ...
        visible: true,
        active: (context) =>
            (context.atom === undefined && context.meta === undefined) ||
    ...
    },
    {
        ...
        visible: (context) => context.paragraph !== undefined,
        active: (context) =>
            context.paragraph !== undefined && context.atParagraphStart,
        handler: (context) =>
            context.paragraph
                ? rootWithNode(
                      context,
    ...
    },
    {
        ...
        key: '7',
        visible: (context) =>
            context.paragraph !== undefined && context.list === undefined,
        active: (context) =>
            context.paragraph !== undefined && context.list === undefined,
        handler: (context) =>
            rootWithNode(
    ...
    },
    {
        ...
        key: '7',
        visible: (context) =>
            context.list !== undefined && context.list.isNumbered(),
        active: (context) =>
            context.list !== undefined && context.list.isNumbered(),
        handler: (context) =>
            context.list
    ...
    },
    {
        ...
        active: (context) =>
            ...
            context.undoPosition < context.undoStack.length - 1,
    ...
    },
    {
        ...
        handler: (context) => {
            ...
            // Save the copied content to the clipboard
            const copy = context.root.copyRange(context.range);
            if (copy !== undefined) context.handleCopy(copy);
            return undefined;
        },
    },
    {
        ...
        handler: (context, utilities, key) => {
            ...
            if (key.length === 1) {
                ...
                if (context.isSelection) {
                    if (context.code) {
                        if (
                            context.code.getCodeNode() ===
                            sortedRange.start.node
                        ) {
                            const newText =
                                insertionPoint.node.withoutRange(sortedRange);
                            if (newText === undefined) return;
                ...
                // Update the chapter
                return rootWithNode(context, context.root, newRoot, () => {
                    return { node: newText, index: insertionPoint.index + 1 };
                });
            }
        },
    },

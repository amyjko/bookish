...
export default class InlineCodeNode extends MetadataNode<string> {
    ...
    copy() {
        return new InlineCodeNode(this.getText(), this.getMeta()) as this;
    }

    withMeta(meta: string): MetadataNode<string> {
        return new InlineCodeNode(this.getText(), meta);
    }
    withText(text: TextNode): MetadataNode<string> {
        return new InlineCodeNode(text, this.getMeta());
    }
}

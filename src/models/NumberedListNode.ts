...
export type NumberedListParentType =  BlockParentNode | NumberedListNode;
export type NumberedListNodeType = FormattedNode | NumberedListNode;

export class NumberedListNode extends Node<NumberedListParentType> {

    #items: NumberedListNodeType[];

    constructor(parent: NumberedListParentType, items: Array<FormattedNode | NumberedListNode>) {
    ...
    getLevel(): number {
        ...
        if(parent instanceof NumberedListNode)
